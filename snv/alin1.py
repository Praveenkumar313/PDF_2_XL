...
class PDFConverterApp:
    ...
    def tddm(self): 
        subprocess.run(["python", "tddm.py"])
        print("Executing tddm.py script!")

    def tddim(self): 
        subprocess.run(["python", "tddim.py"])
        print("Executing tddim.py script!")

    def tdmplm(self): 
        subprocess.run(["python", "tdmplm.py"])
        print("Executing tdmplm.py script!")

    def tdmplmd(self): 
        subprocess.run(["python", "tdmplmd.py"])
        print("Executing tdmplmd.py script!")
